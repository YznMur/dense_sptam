  ...
  , last_publish_seq_(0)
{
	...
	sub_img_l_.subscribe(nhp, "/kitti_stereo/left/image_rect", 1);
	sub_info_l_.subscribe(nhp, "/kitti_stereo/left/camera_info", 1);
	sub_img_r_.subscribe(nhp, "/kitti_stereo/right/image_rect", 1);
	sub_info_r_.subscribe(nhp, "/kitti_stereo/right/camera_info", 1);
